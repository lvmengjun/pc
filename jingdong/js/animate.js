        ...
        if (typeof effect === "number") {
            ...
            for (var i = 0; i < ary.length; i++) {
                if (effect === (i + 1)) {
                    ...
                    fnEffect = curItem.length === 1 ? Tween[curItemFir] : Tween[curItemFir][curItemTwo];
                    break;
                }
            }
            ...
            fnEffect = effect.length === 1 ? Tween[effectFir] : Tween[effectFir][effectTwo];
